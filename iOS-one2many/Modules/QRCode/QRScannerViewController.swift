...
extension QRScannerViewController {
    ...
    func found(code: String) {
        ...
        do {
            ...
            UserDefaults.baseUrl = model.tenantApiUrl.replacingOccurrences(of: "https://", with: "", options: [])
            UserDefaults.projectId = model.projectId
            AuthenticationConstants.PROJECTID = model.projectId
            AuthenticationConstants.HOST = model.tenantApiUrl.replacingOccurrences(of: "https://", with: "", options: [])
