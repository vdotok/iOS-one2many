...
class ControlsViewBuilder {

    func build(with navigationController: UINavigationController?) -> UIViewController {
        
        let storyboard = UIStoryboard(name: "AVPlayerBoard", bundle: Bundle(for: LandingBuilder.self))
...
class ControlsViewController: UIViewController, RemoteCommandHandler {
    ...
    private var autoPlayObserver: NSObjectProtocol!
    ...
    override func viewDidLoad() {
        ...
        notificationCenter.addObserver(self, selector: #selector(autoPlay), name: .startPlaying, object: nil)
    ...
    @IBAction func moveToLandingPage(){
        let lVC = LandingBuilder().build(with: self.navigationController)
